...
(function loadGlobalUI(){
  ...
  const engagement=document.createElement('script');engagement.src='js/detail-engagement.js?v='+version;engagement.defer=true;document.head.appendChild(engagement);
